...
public class gridlayout2Adapter extends RecyclerView.Adapter {
    //数据源
    private List<Pair> dataList;

    //构造函数
    public gridlayout2Adapter(List<Pair> dataList) {
...
//        } else {
        ...
        return new BodyViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_waithandle2, null));
//        }
    }
...
//    }
    ...
    public class BodyViewHolder extends RecyclerView.ViewHolder {
        ...
        public BodyViewHolder(View itemView) {
            super(itemView);
            numView = (TextView) itemView.findViewById(R.id.wait2_num);
            titleView = (TextView) itemView.findViewById(R.id.wait2_title);
        }
