...
import com.zzz.wuye.sellhouse.view.sellhouseDetail;
...
public class myexchange extends BaseActivity implements View.OnClickListener {
    ...
    private OnRecyclerviewItemClickListener onRecyclerviewItemClickListener = new OnRecyclerviewItemClickListener() {
        ...
        public void onItemClickListener(View v, int position) {
            if (editorStatus) {
                ...
                Intent intent = new Intent(myexchange.this,exchangeadd.class);
    ...
    private void initFruits() {
        String bql ="select * from stuff where uploadId='"+ BmobUser.getCurrentUser(User.class).getObjectId()+"'";
...
//                Log.i()
                for (int i = 0 ; i <fruitList.size(); i++) {
                    if (fruitCheck.get(i)) {
                        Log.i("fruitCheck", String.valueOf(i)+fruitList.get(i).getTitle());
                        stuff p2 = new stuff();
