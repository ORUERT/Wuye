package com.zzz.wuye.view;//package com.zzz.wuye.view;
//
...
//            url = Constants.BASE_URL + "Newsitem?method=releaseNewsWithImage";
//            OkHttpUtils
//                    .post()
...
//        } else {
//            url = Constants.BASE_URL + "Newsitem?method=releaseNewsWithoutImage";
//            OkHttpUtils
//                    .post()
//                    .url(url)
//                    .id(1)
