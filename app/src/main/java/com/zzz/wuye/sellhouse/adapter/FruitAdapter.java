package com.zzz.wuye.sellhouse.adapter;
...
public class FruitAdapter extends RecyclerView.Adapter<FruitAdapter.ViewHolder> implements View.OnClickListener{
    ...
    private List<houseCard> mFruitList;
    ...
    public FruitAdapter(List<houseCard> fruitList,OnRecyclerviewItemClickListener mOnRecyclerviewItemClickListener) {
        mFruitList = fruitList;
        this.mOnRecyclerviewItemClickListener = mOnRecyclerviewItemClickListener;
    }

    public FruitAdapter(List<houseCard> fruitList,OnRecyclerviewItemClickListener mOnRecyclerviewItemClickListener,Context context,List<Boolean> fruitCheck) {
        mFruitList = fruitList;
        this.mOnRecyclerviewItemClickListener = mOnRecyclerviewItemClickListener;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        houseCard fruit = mFruitList.get(position);
        holder.fruitName.setText(handleTextDisplay(fruit.getHousetitle(),8));
