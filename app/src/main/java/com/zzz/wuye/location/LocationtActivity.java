...
public class LocationtActivity extends Activity implements LocationSource,
...
//            ActivityCompat.requestPermissions(LocationtActivity.this,permissions,1);
//
//        }
...
//        }
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(LocationtActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    ...
                    Inputtips inputTips = new Inputtips(LocationtActivity.this, inputquery);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(LocationtActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(LocationtActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(LocationtActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position != searchResultAdapter.getSelectedPosition()) {
                ...
                searchResultAdapter.notifyDataSetChanged();
            }else if(position == searchResultAdapter.getSelectedPosition()){
                PoiItem poiItem = (PoiItem) searchResultAdapter.getItem(position);
                Intent intent = new Intent();
                Log.i("location",poiItem.getCityName()+"!" + poiItem.getAdName()+"@" + poiItem.getSnippet()+poiItem.getTitle());
                String str = "";
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(LocationtActivity.this, "erroCode " + rCode , Toast.LENGTH_SHORT).show();
            }
        }
    };
